...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/5fcace0a595c6f00157ad7ac
...
To start editing your site, you can use the Sanity interface at https://nervous-mint-ace0a.sanity.studio/.
...
Generated at `2020-12-05T00:03:21.142Z` by Stackbit version `0.3.38`.